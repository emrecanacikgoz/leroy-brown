...
def main(cfg: OmegaConf):
    ...
    print(f"\npath-type: {type(cfg.data.train_path)}")
    print(f"input_features-type: {type(cfg.data.input_features)}")
    print(f"target_features-type: {type(cfg.data.target_features)}")
    print(f"window-type: {type(cfg.data.window)}")
    print(f"num_bins-type: {type(cfg.data.num_bins)}")
    print(f"add_gaussian_noise-type: {type(cfg.data.add_gaussian_noise)}\n")
    ...
    #all_data = torch.utils.data.ConcatDataset([train_data, valid_data])
